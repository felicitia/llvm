...
function(libft_get_architecture return_arch)
  ...
  file(WRITE "${CMAKE_CURRENT_BINARY_DIR}/libft_detect_arch.c" ${detect_arch_src_txt})
  ...
  try_run(run_dummy compile_dummy "${CMAKE_CURRENT_BINARY_DIR}" "${CMAKE_CURRENT_BINARY_DIR}/libft_detect_arch.c" COMPILE_OUTPUT_VARIABLE local_architecture)
  ...
  file(REMOVE "${CMAKE_CURRENT_BINARY_DIR}/libft_detect_arch.c")
endfunction()

function(libft_is_aarch64_a64fx return_is_aarch64_a64fx)
...
endfunction(libft_is_aarch64_a64fx)
